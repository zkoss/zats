/* ListheaderSortAgentBuilder.java
 ...
 *
 */
public class ListheaderSortAgentBuilder implements OperationAgentBuilder<ComponentAgent,SortAgent> {
	...
	private class SortAgentImpl extends SwitchedSortAgentImpl{
		...
		public String getSortDirection() {
			return target.as(Listheader.class).getSortDirection();
		}
