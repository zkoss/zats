 ...
 * @author pao
 */
public class HeaderSizeAgentBuilder implements OperationAgentBuilder<SizeAgent> {
	...
	private class HeaderSizeAgentImpl extends AgentDelegator implements SizeAgent {
		...
		public void resize(int width, int height) {
			...
			data.put("", innerWidth);
			cc.postUpdate(desktopId, container.getUuid(), cmd, data);
			...
			cc.postUpdate(desktopId, head.getUuid(), cmd, data);
		}
	}
}
